        ...
        sock.ev.on("connection.update", async (update) => {
            ...
            if (connection === "open") {
                ...
                try {
                    ...
                    const sessionId = "HASSNAIN-MD~" + base64;
                    ...
                    const successMsg = {
                        text:
                            ...
                            `_Powered by HASSNAIN-MD\n\n` +
                            `🔗 *Useful Links:*\n` +
                            `▸ GitHub: https://github.com/kinghacker756/kinghacker756\n` +
                            `▸ https://whatsapp.com/channel/0029Vb5Wj7A1iUxVukeiWx21`,
                        contextInfo: {
